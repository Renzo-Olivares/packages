...
void main() {
  ...
  testWidgets('Action sheet semantics', (WidgetTester tester) async {
    ...
    expect(dialogNode.role, SemanticsRole.dialog);
    expect(dialogNode, isSemantics(label: 'Alert', scopesRoute: true, namesRoute: true));

    expect(find.semantics.byLabel('The title'), isSemantics(label: 'The title'));
    expect(find.semantics.byLabel('The message'), isSemantics(label: 'The message'));

    expect(
      find.semantics.byLabel('One'),
      isSemantics(
        label: 'One',
        isButton: true,
        isFocusable: true,
